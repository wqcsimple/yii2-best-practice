...
class BaseApiController extends Controller
{
    ...
    public function beforeAction($action)
    {
        ...
        $this->user_id = AdminApiService::before($this->params, $this->action->id, $this->action->controller->id);
        ...
        if ($this->user_id)
        {
            AdminApiService::doUserStat($this->user_id);
        }
    ...
    {
        AdminApiService::checkParams($this->params, $requiredParams);
    }
