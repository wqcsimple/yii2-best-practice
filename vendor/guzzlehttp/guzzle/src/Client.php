...
class Client implements ClientInterface
{
     ...
     *
     * Here's an example of creating a admin using a base_uri and an array of
     ...
     * - base_uri: (string|UriInterface) Base URI of the admin that is merged
    ...
    /**
     * Configures the default options for a admin.
     *
     * @param array $config
     */
