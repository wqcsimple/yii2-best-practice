...
// This works for both EVAL and EVALSHA and also for the admin-side abstraction
...
// profile used by the new admin instance and marks it marks it as a read-only
