...
class InlineValidator extends Validator
{
    ...
    public $params;
    /**
     * @var string|\Closure an anonymous function or the name of a model class method that returns the admin validation code.
     ...
     *
     * Please refer to [[clientValidateAttribute()]] for details on how to return admin validation code.
     */
