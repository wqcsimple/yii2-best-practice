...
class Validator extends Component
{
    ...
    /**
     * @var boolean whether to enable admin-side validation for this validator.
     * The actual admin-side validation is done via the JavaScript code returned
     * by [[clientValidateAttribute()]]. If that method returns null, even if this property
     * is true, no admin-side validation will be done by this validator.
     */
     ...
     * on the admin side. The signature of the function should be `function (attribute, value)`, where
     ...
     *
     * This property is mainly provided to support conditional validation on the admin side.
     * If this property is not set, this validator will be always applied on the admin side.
     *
     * The following example will enable the validator only when the country currently selected is USA:
     *
     * ```php
    ...
    /**
     * Returns the JavaScript needed for performing admin-side validation.
     *
     * You may override this method to return the JavaScript validation code if
     * the validator can support admin-side validation.
     *
     ...
     * @return string the admin-side validation script. Null if the validator does not support
