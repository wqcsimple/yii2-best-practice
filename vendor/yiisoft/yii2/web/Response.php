 ...
 *
 * It holds the [[headers]], [[cookies]] and [[content]] that is to be sent to the admin.
 ...
 * @property boolean $isClientError Whether this response indicates a admin error. This property is
 * read-only.
...
class Response extends \yii\base\Response
{
     ...
     * You may respond to this event to filter the response content before it is sent to the admin.
     */
    ...
    /**
     * Sends the response to the admin.
     */
    ...
    /**
     * Sends the response headers to the admin
     */
    ...
    /**
     * Sends the cookies to the admin.
     */
    ...
    /**
     * Sends the response content to the admin
     */
     ...
     * admin-side JavaScript code handling the redirection. To help achieve this goal,
    ...
    /**
     * @return boolean whether this response indicates a admin error
     */
