...
class ActiveForm extends Widget
{
    ...
    /**
     * @var boolean whether to enable admin-side data validation.
     ...
     * This property must be set true if you want to support admin validation and/or AJAX validation, or if you
    ...
    /**
     * @var array the admin validation options for individual attributes. Each element of the array
